@php
    ...
    $logisticsNav = [
        ['route' => 'admin.logistics.companies.index', 'label' => 'Companies', 'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
        ['route' => 'admin.logistics.workers.index', 'label' => 'Workers', 'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],
        ['route' => 'admin.logistics.vehicles.index', 'label' => 'Vehicles', 'icon' => 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4'],
        ['route' => 'admin.logistics.municipalities.index', 'label' => 'Municipalities', 'icon' => 'M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z'],
        ['route' => 'admin.logistics.zones.index', 'label' => 'Shipping zones', 'icon' => 'M9 20l-5.447-2.724A2 2 0 013 15.382V6.618a2 2 0 011.553-1.948L9 2l5.447 2.724A2 2 0 0116 6.618v8.764a2 2 0 01-1.553 1.948L9 20z'],
        ['route' => 'admin.logistics.dispatch.index', 'label' => 'Dispatch', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
        ['route' => 'admin.logistics.warnings.index', 'label' => 'Warnings', 'icon' => 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z'],
    ];
@endphp
...
<aside class="admin-sidebar" :class="{ 'admin-sidebar--open': open }">
    ...
    <nav class="admin-sidebar__nav" aria-label="Admin navigation">
        ...
        @if (collect($logisticsNav)->contains(fn ($item) => Route::has($item['route'])))
            <div class="admin-sidebar__section">
