  ...
  dataset.map(function (row) {
    ...
    content += `
            <tr>
                ...
                <td><img src="${SERVER}images/subcategoria/${row.imagen_subcategoria}" class="materialboxed" height="100"></td>
                <td>${row.subcategoria_producto}</td>
                <td>${row.categoria_producto}</td>
                <td>
                    <a onclick="openUpdate(${row.idsubcategoria_producto})" class="btn green tooltipped" data-tooltip="Actualizar">
                    <i class="large material-icons">mode_edit</i>
                    </a>
                    <a onclick="openDelete(${row.idsubcategoria_producto})"class="btn  brown tooltipped" data-tooltip="Eliminar">
