...
$pdf->startReport('Productos con descuentos');
...
if ($dataProductos = $vendida->ProductoDescuento()) {
    ...
    $pdf->cell(35, 10, utf8_decode('Total con descuento'), 1, 1, 'C', 1);
    ...
    foreach ($dataProductos as $rowProducto) {
        $pdf->cell(25, 10, $rowProducto['idproducto'], 1, 0, 'C');
        $pdf->cell(70, 10, utf8_decode($rowProducto['nombre_producto']), 1, 0, '', 1);
        $pdf->cell(30, 10, '$' . $rowProducto['precio_producto'], 1, 0, '', 1);
        $pdf->cell(30, 10, '$' . round($rowProducto['precio_producto'] * ($rowProducto['porcentaje_descuento'] / 100),2), 1, 0, '', 1);
        $pdf->cell(35, 10, '$' . round($rowProducto['precio_producto'] - ($rowProducto['precio_producto'] * ($rowProducto['porcentaje_descuento'] / 100)), 2), 1, 1, '', 1);
    }
} else {
