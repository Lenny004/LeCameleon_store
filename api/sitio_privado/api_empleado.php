        ...
        switch ($_GET['action']) {
            ...
            case 'update':
                ...
                if (!$empleado->setId($_POST['ide'])) {
                    ...
                    $result['exception'] = 'empleado inexistente';
                } elseif (!$empleado->setNombre($_POST['nombreM'])) {
                    $result['exception'] = 'Nombre incorrecto';
                } elseif (!$empleado->setApellido($_POST['apellidoM'])) {
                    $result['exception'] = 'Apellido incorrecto';
                } elseif (!$empleado->setDUI($_POST['DUIM'])) {
                    $result['exception'] = 'DUI incorrecto';
                } elseif (!$empleado->setNIT($_POST['NITM'])) {
                    $result['exception'] = 'nit incorrecto';
                } elseif (!$empleado->setTelefono($_POST['telefonoM'])) {
                    $result['exception'] = 'telefono incorrecto';
                } elseif (!$empleado->setCorreo($_POST['correoM'])) {
                    $result['exception'] = 'correo incorrecto';
                } elseif (!$empleado->setFecha($_POST['fechaM'])) {
                    $result['exception'] = 'fecha incorrecta';
                } elseif (!$empleado->setTipo($_POST['tipoM'])) {
                    $result['exception'] = 'Seleccione un tipo';
