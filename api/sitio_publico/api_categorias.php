...
if (isset($_GET['action'])) {
    ...
    $result = array('estado' => 0, 'dataset' => null, 'dataset2' => null, 'message' => null, 'exception' => null, 'suma_categorias' => null);
    ...
    switch ($_GET['action']) {
        ...
        case 'obtenerSubcategorias':
            if (!$subcategoria->setidCategoriaProducto($_POST['idcategoria_menu'])) {
                $result['exception'] = 'Categoria incorrecta';
            } elseif ($result['dataset2'] = $subcategoria->obtenerSubcategorias()) {
                $result['estado'] = 1;
            } elseif (Database::getException()) {
                $result['exception'] = Database::getException();
            } else {
